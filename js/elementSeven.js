...
$(function() {
  ...
  $('#squareRight').droppable({
    ...
    drop: function (event, ui) {
      if( rotation1 == 60 | rotation1 == 150 | rotation1 == 240 | rotation1 == 330 | degree == 45 | degree == 135 | degree == 225 | degree == 315 ) {
...
$(function() {
  ...
  console.log("ratation1 " + rotation1)
  }
});
